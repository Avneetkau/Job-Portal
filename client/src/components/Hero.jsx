  ...
  return (
    <div className="container 2xl:px-20 mx-auto my-10 ">
      <div className="bg-linear-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl">
        ...
        <p
        className="mb-8 max-w-xl mx-auto text-sm font-light px-5">Your next job can be your dream job, jut unloack the path of your success from here.</p>
      ...
      <div className="flex items-center">
        <img src={assets.location_icon} alt="search" className="h-4 sm:h-5"/>
        <input type="text"
